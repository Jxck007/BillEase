...
export const TRANSLATIONS: Record<string, Record<Language, string>> = {
  ...
  changeLanguageToTamil: { en: 'Change language to Tamil', ta: 'தமிழுக்கு மாற்று' },
  changeLanguageToEnglish: { en: 'Change language to English', ta: 'ஆங்கிலத்திற்கு மாற்று' },
  ...
  backToDashboard: { en: 'Back to Dashboard', ta: 'முகப்புக்குத் திரும்பு' },
  ...
  somethingWentWrong: { en: 'Something went wrong', ta: 'ஏதோ தவறு ஏற்பட்டது' },
  sectionDisplayFailed: { en: 'BillEase could not display this section. Your saved records and local drafts were not changed.', ta: 'BillEase-ஆல் இந்தப் பகுதியைக் காட்ட முடியவில்லை. சேமிக்கப்பட்ட பதிவுகள் மற்றும் உள்ளூர் வரைவுகள் மாற்றப்படவில்லை.' },
  errorReference: { en: 'Error reference', ta: 'பிழை குறிப்பீடு' },
  reloadSection: { en: 'Reload section', ta: 'இந்தப் பகுதியை மீண்டும் ஏற்று' },
  restoreLatestLocalDraft: { en: 'Restore latest local draft', ta: 'சமீபத்திய உள்ளூர் வரைவை மீட்டெடு' },
  copyErrorReference: { en: 'Copy error reference', ta: 'பிழை குறிப்பீட்டை நகலெடு' },
  copyThisErrorReference: { en: 'Copy this error reference:', ta: 'இந்தப் பிழை குறிப்பீட்டை நகலெடுக்கவும்:' },
