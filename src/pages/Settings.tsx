    ...
    <div className="space-y-4">
      ...
      <Panel title={text('UPI Payment', 'UPI கட்டணம்')} description={text('QR payment settings for invoices and quotations.', 'விலைப்பட்டியல் மற்றும் விலைமதிப்பீட்டுக்கான QR கட்டண அமைப்புகள்.')}>
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Switch checked={state.settings.showPaymentStatusOnInvoicePdf === true} onChange={(checked) => updateSettings({ showPaymentStatusOnInvoicePdf: checked })} label={text('Show payment status on invoice PDF', 'விலைப்பட்டியல் PDF-ல் கட்டண நிலையைக் காட்டு')} secondary={text('Off by default. Individual invoices can override this without changing payment records.', 'இயல்பாக அணைக்கப்பட்டுள்ளது. கட்டணப் பதிவை மாற்றாமல் தனிப்பட்ட விலைப்பட்டியலில் மாற்றலாம்.')} />
