...
export default function InvoicePreview() {
  ...
  const openReceipt = (payment: Payment) => {
    ...
    const openAfterClose = () => setReceiptPayment(payment);
    window.addEventListener('billease:document-fullscreen-closed', openAfterClose, { once: true });
    window.dispatchEvent(new Event('billease:close-document-fullscreen'));
  };
